...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('root://xrootd-cms.infn.it///store/data/Run2023B/ParkingDoubleMuonLowMass0/MINIAOD/PromptReco-v1/000/366/442/00000/77993198-8548-4532-83bc-7b2a8863c9b9.root')
)
...
process.LooseTrackCandidate = cms.EDProducer("TrackFromCandProducer",
...
process.RecoTrackCand = cms.EDProducer("ConcreteChargedCandidateProducer",
    particleType = cms.string('pi+'),
    src = cms.InputTag("LooseTrackCandidate")
)


process.TwoMuonsCand = cms.EDProducer("CandViewShallowCloneCombiner",
    checkCharge = cms.bool(False),
...
process.TwoMuonsOneTrackKalmanVtxFit = cms.EDProducer("KalmanVertexFitCompositeCandProducer",
    src = cms.InputTag("TwoMuonsOneTrackCand")
)


process.TwoMuonsOneTrackKinVtxFit = cms.EDProducer("KinematicVertexFitCompositeCandProducer",
...
process.LooseTrack = cms.EDFilter("PFCandFilter",
...
process.TwoMuonsCandFilter = cms.EDFilter("CandViewCountFilter",
    minNumber = cms.uint32(1),
...
process.TwoMuonsOneTrackCandFilter = cms.EDFilter("CandViewCountFilter",
    minNumber = cms.uint32(1),
    src = cms.InputTag("TwoMuonsOneTrackCand")
)
...
process.PlotsAfter2Mu1Track = cms.EDAnalyzer("RecoMuonAnalyzer",
    muonsInputTag = cms.InputTag("looseMuons")
)


process.PlotsAfterDiMuonCand = cms.EDAnalyzer("RecoMuonAnalyzer",
    muonsInputTag = cms.InputTag("looseMuons")
)
...
process.PlotsAfterOnePFCand = cms.EDAnalyzer("RecoMuonAnalyzer",
    muonsInputTag = cms.InputTag("slimmedMuons")
)


process.PlotsAfterPhiPiCand = cms.EDAnalyzer("RecoMuonAnalyzer",
    muonsInputTag = cms.InputTag("looseMuons")
)


process.PlotsAfterPhiPiCandSel = cms.EDAnalyzer("RecoMuonAnalyzer",
    muonsInputTag = cms.InputTag("looseMuons")
)
...
process.TwoMuOneTrackSelSeq = cms.Sequence(process.InitialPlots+process.Tau3MuHLTFilter+process.PlotsAfterTrigger+process.PlotsAfterOnePFCand+process.looseMuons+process.PlotsAfterLooseMuon+process.TwoMuonsFilter+process.DiMuonCand+process.DiMuonCandFilter+process.PlotsAfterDiMuonCand+process.LooseTrack+process.OneTrackFilter+process.LooseTrackCandidate+process.RecoTrackCand+process.TwoMuonsOneTrackCand+process.TwoMuonsOneTrackKalmanVtxFit+process.PlotsAfter2Mu1Track+process.TwoMuonsOneTrackCandFilter+process.PlotsAfterPhiPiCandSel)


process.DsPhiPiSkim = cms.Path(process.TwoMuOneTrackSelSeq+process.unpackedPatTrigger+process.Tree3Mu)
